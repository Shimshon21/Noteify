	...
	function register(){
		$("#btnRegister").click((e)=>{	
			...
			if(inputName && inputPass && inputEmail ){
				if( inputPass ===  $("#InputConfirmPassword").val()){
			var s = window.localStorage
			var data = {"pass": inputPass, "name": inputName,"tasks":{}};
		    s.setItem(inputEmail, JSON.stringify(data));
			$("#reg_1").hide(500);
			$("#login_1").show(500);
				}else{
		...
		alert("One of the inputs are missing.");
		}
		});
